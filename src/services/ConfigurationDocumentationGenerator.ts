...
export class ConfigurationDocumentationGenerator {
   ...
   */
  async generateConfigurationDocumentation(projectRoot: string, outputPath: string): Promise<void> {
   ...
   */
  private async generateConfigurationReadme(configPath: string): Promise<void> {
...
`;
   ...
   */
  private async generateDefaultConfigDoc(projectRoot: string, configPath: string): Promise<void> {
...
`;
   ...
   */
  private async generateCustomizationDoc(configPath: string): Promise<void> {
