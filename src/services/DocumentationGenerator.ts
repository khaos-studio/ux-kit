...
export class DocumentationGenerator {
  constructor(
    ...
    private commandDocGenerator: CommandDocumentationGenerator,
    private configDocGenerator: ConfigurationDocumentationGenerator,
   ...
   */
  async generateAllDocumentation(projectRoot: string, outputPath: string): Promise<void> {
    try {
   ...
   */
  private async ensureDocumentationDirectories(outputPath: string): Promise<void> {
    const directories = [
      `${outputPath}/commands`,
   ...
   */
  private async generateMainIndex(projectRoot: string, outputPath: string): Promise<void> {
...
`;
   ...
   */
  private async generateExamples(projectRoot: string, outputPath: string): Promise<void> {
...
`;
   ...
   */
  private async generateTemplateDocumentation(projectRoot: string, outputPath: string): Promise<void> {
