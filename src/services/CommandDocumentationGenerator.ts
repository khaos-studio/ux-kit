...
export class CommandDocumentationGenerator {
  constructor(private fileSystem: IFileSystemService) {}

  /**
   * Generate command documentation
   */
  async generateCommandDocumentation(projectRoot: string, outputPath: string): Promise<void> {
   ...
   * Generate main commands README
   */
  private async generateCommandsReadme(commandsPath: string): Promise<void> {
...
`;
   ...
   */
  private async generateInitCommandDoc(commandsPath: string): Promise<void> {
...
`;
   ...
   */
  private async generateStudyCommandDoc(commandsPath: string): Promise<void> {
...
`;
   ...
   */
  private async generateResearchCommandDoc(commandsPath: string): Promise<void> {
