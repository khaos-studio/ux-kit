...
export class ConfigurationValidator {
   ...
   */
  private validateTemplates(templates: any, errors: string[]): void {
   ...
   */
  private validateOutput(output: any, errors: string[]): void {
    if (!output.directory) {
   ...
   */
  private validateResearch(research: any, errors: string[]): void {
