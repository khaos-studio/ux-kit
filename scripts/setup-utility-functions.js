...
/**
 * T002: Utility Functions Setup Script
 * 
...
# Log with color (requires colors.sh)
log_info_colored() {
    if [[ $LOG_LEVEL -ge $LOG_LEVEL_INFO ]]; then
...
log_warn_colored() {
    if [[ $LOG_LEVEL -ge $LOG_LEVEL_WARN ]]; then
        echo -e "\$(get_timestamp) \${YELLOW}[WARN]\${NC} $*" >&2
    fi
}
...
run_command_with_timeout() {
    ...
    log_debug "Running command with timeout $timeout: $cmd"
