...
exports.CodexCommandGenerator = void 0;
/**
 * Service for generating and managing Codex command templates
 */
class CodexCommandGenerator {
    constructor(fileSystemService) {
        this.defaultTemplatePath = 'templates/codex';
        this.fileSystemService = fileSystemService;
    }
    /**
     * Generate Codex v2 configuration file
     */
    async generateTemplates(config) {
        try {
     ...
     */
    async generateCommandTemplate(commandName, config) {
     ...
     */
    formatTemplateAsMarkdown(template) {
        const title = template.name.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ');
     ...
     */
    parseMarkdownTemplate(name, markdown) {
...
exports.CodexCommandGenerator = CodexCommandGenerator;
//# sourceMappingURL=CodexCommandGenerator.js.map