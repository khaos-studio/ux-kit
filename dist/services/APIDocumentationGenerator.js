...
class APIDocumentationGenerator {
     ...
     */
    async generateAPIDocumentation(projectRoot, outputPath) {
     ...
     */
    async generateAPIReadme(apiPath) {
...
`;
     ...
     */
    async generateServicesDoc(apiPath) {
...
`;
     ...
     */
    async generateContractsDoc(apiPath) {
...
`;
     ...
     */
    async generateExamplesDoc(apiPath) {
