...
exports.DirectoryStructureService = void 0;
...
class DirectoryStructureService {
     ...
     */
    async createCodexDirectoryStructure() {
        const errors = [];
     ...
     */
    async createGitkeepFile(gitkeepPath) {
        try {
     ...
     */
    async areAllDirectoriesCreated() {
...
exports.DirectoryStructureService = DirectoryStructureService;
//# sourceMappingURL=DirectoryStructureService.js.map