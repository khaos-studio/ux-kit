...
exports.UserGuideGenerator = void 0;
class UserGuideGenerator {
     ...
     * Generate user guide
     */
    async generateUserGuide(projectRoot, outputPath) {
     ...
     */
    async generateUserGuideReadme(userGuidePath) {
...
`;
     ...
     */
    async generateGettingStartedDoc(userGuidePath) {
...
`;
     ...
     */
    async generateTutorialsDoc(userGuidePath) {
...
`;
     ...
     */
    async generateExamplesDoc(userGuidePath) {
...
`;
     ...
     */
    async generateTroubleshootingDoc(userGuidePath) {
...
exports.UserGuideGenerator = UserGuideGenerator;
//# sourceMappingURL=UserGuideGenerator.js.map